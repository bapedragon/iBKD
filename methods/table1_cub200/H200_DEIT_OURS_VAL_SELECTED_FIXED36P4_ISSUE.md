# CUB-200 DeiT-Ti Ours val-selected / fixed 36.40 Teacher Issue

## 제목

```text
[Request]: 박철현 CUB-200 DeiT-Ti Ours val-best 선택 + fixed 36.40 Teacher + test 1회
```
...
```text
python methods/table1_cub200/train.py --full-run --student deit_ti --method ours --batch-size 128 --selection-protocol val_then_test_once --teacher-contract fixed_build543 --val-per-class 6 --val-split-seed 2027 --teacher-root teachers/checkpoints/cub200_table1_resnet56_32 --data-dir /app/output/cub200_deit_ti_ours_b128_valselect_fixed36p4_seed1/data/cub200 --output-dir /app/output/cub200_deit_ti_ours_b128_valselect_fixed36p4_seed1 --run-name cub200_deit_ti_ours_b128_valselect_fixed_teacher36p4_300ep_seed1_split2027 --num-workers 4
```
...
```text
/app/output/cub200_deit_ti_ours_b128_valselect_fixed36p4_seed1/cub200_deit_ti_ours_b128_valselect_fixed_teacher36p4_300ep_seed1_split2027/summary.json
/app/output/cub200_deit_ti_ours_b128_valselect_fixed36p4_seed1/cub200_deit_ti_ours_b128_valselect_fixed_teacher36p4_300ep_seed1_split2027/validation_split.json
/app/output/cub200_deit_ti_ours_b128_valselect_fixed36p4_seed1/cub200_deit_ti_ours_b128_valselect_fixed_teacher36p4_300ep_seed1_split2027/student_best.pt
```
