...
| Vanilla-b128 | timm DeiT-Ti `fb_in1k` | 224 x 224 | CE only, 300 epochs, batch 128 |
| LG | timm DeiT-Ti `fb_in1k` | 224 x 224 | official LG mechanics, 300 epochs, batch 128 |
| ALG | timm DeiT-Ti `fb_in1k` | 224 x 224 | ALG paper controller on official LG, 300 epochs, batch 128 |
| Ours-b64 | timm DeiT-Ti `fb_in1k` | 224 x 224 | unchanged Ours protocol, 300 epochs, batch 64 |
| Ours-b128 | timm DeiT-Ti `fb_in1k` | 224 x 224 | Ours batch-only ablation, 300 epochs, batch 128 |
...
```text
python methods/run_cub200_full_transfer_all.py --full-run --num-workers 4 --output-dir /app/output/cub200_full_transfer_all_full_seed1
```
